...
file_name = path_+'\csv_SOCIALAPT_page_parsing_'+parsing_day+'.csv'
list_href = []
list_name = []
list_group = []
...
for item_key, item_value in dict_item.items():
    ...
    if req.status_code == 200:
        src = req.text
        with open(fr'C:\Users\user\Scrapy_project\Archive_SOCIALAPT\href_SOCIALAPT_requests\{count}_{item_value[1]}_{parsing_day}.html', 'w', encoding='utf-8') as file:
            file.write(src)
        print('thats OK')
    else:
