...
file_name = path_+'\csv_NAZDOROV_page_parsing_'+now+'.csv'
list_href = []
list_name = []
list_group = []
...
try:
    ...
    for k, v in dict_item.items():
        ...
        group = v[1]
        #print(group)
        path_file = fr'C:\Users\user\Scrapy_project\Archive_NAZDOROV\href_NAZDOROV_requests\{count}_{v[1]}_{now}.html'
        print(path_file)
